...
<fmt:bundle basename="pagecontent">
    ...
    <div class="mainContent">
        <div class="container">
            <div class="row">
                <h1><fmt:message key="registration.welcome.text"/></h1>
            </div>
            <div class="row">
                <form action="cleaning" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="license" id="gridCheck" required
                                   value="">
                    ...
                    <button type="submit" class="btn btn-primary"><fmt:message
                            key="registration.signin.bytton.text"/></button>
                </form>
