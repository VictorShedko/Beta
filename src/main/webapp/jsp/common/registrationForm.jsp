    ...
    <form action="cleaning" method="post" class="needs-validation" novalidate>
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputName" placeholder="name" name="username" required minlength="6" maxlength="25">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" class="form-control" id="inputPassword" placeholder="Password" name="password" required minlength="6" maxlength="25">
                <div class="valid-feedback">
                    <fmt:message key="registration.username.feedback.valid"/>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputLogin" placeholder="login" name="login" required minlength="6" maxlength="25">
                <div class="valid-feedback">
                    <fmt:message key="registration.username.feedback.valid"/>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                ...
                <label class="form-check-label" for="CustomerRadio">
                    <fmt:message key="registration.label.role.cutomer.text"/>
                </label>
            </div>
            <div class="form-check form-check-inline">
