        ...
        if (!request.getParts().isEmpty()) {
            ...
            request.getParts().forEach(part -> {
                ...
                try {
                    ...
                    downloadedFile = new File(servletContext.getRealPath("")+UPLOAD_PATH + File.separator + newFileName);
                    part.write(servletContext.getRealPath("")+UPLOAD_PATH + File.separator + newFileName);
