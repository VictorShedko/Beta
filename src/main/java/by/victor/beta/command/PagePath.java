...
public class PagePath {
    ...
    public static final String CREATE_ORDER_RESULT="jsp/common/operationResult.jsp";
    public static final String ACCEPT_ORDER_RESULT="jsp/common/operationResult.jsp";
    public static final String AVAILABLE_ORDERS ="jsp/executor/availebleOrder.jsp";
    public static final String NOTIFY_LIST="jsp/common/notify.jsp";
