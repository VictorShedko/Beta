...
public class HashTest {
    ...
    public Object[][] passAndSalt() {
        ...
        public void alwaysEqualTest(String password1, String salt1, String password2, String salt2) throws ServiceException {
            byte[] hash1=HashGenerator.INSTANCE.getHash(password1,salt1.getBytes());
            byte[] hash2=HashGenerator.INSTANCE.getHash(password2,salt2.getBytes());
    ...
    public void passwordDurability(String password1,String salt1,String password2,String salt2) throws ServiceException {
        byte[] hash1=HashGenerator.INSTANCE.getHash(password1,salt1.getBytes());
        byte[] hash2=HashGenerator.INSTANCE.getHash(password1,salt1.getBytes());
        Assert.assertEquals(hash1,hash2);
    }

    @Test
    public void unpredictabilitySalt(){
        byte[] hash1=HashGenerator.INSTANCE.getNewSalt();
        byte[] hash2=HashGenerator.INSTANCE.getNewSalt();
        Assert.assertNotEquals(hash1,hash2);
    }
